    ...
    <div className="max-w-4xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="relative group">
          <div className="flex flex-col h-full bg-white border border-slate-100 rounded-[2rem] p-10 transition-all duration-500 hover:border-indigo-100 hover:shadow-[0_30px_60px_rgba(79,70,229,0.05)]">
            <h3 className="text-[10px] font-bold text-slate-300 uppercase tracking-[0.25em] mb-8">Source 01 • PDF</h3>
            <div className="flex-1 flex flex-col justify-center">
              <label className="cursor-pointer group/label">
                ...
                <div className="flex flex-col items-center text-center">
                  <div className={`w-16 h-16 rounded-3xl mb-6 flex items-center justify-center transition-all duration-500 ${files.bankStatement ? 'bg-indigo-50 text-indigo-500 scale-110 rotate-3' : 'bg-slate-50 text-slate-300 group-hover/label:bg-slate-100 group-hover/label:text-slate-400'}`}>
                  ...
                  <p className="text-xs text-slate-400 tracking-tight px-4 leading-relaxed max-w-[200px]">
        ...
        <div className="relative group">
          <div className="flex flex-col h-full bg-white border border-slate-100 rounded-[2rem] p-10 transition-all duration-500 hover:border-indigo-100 hover:shadow-[0_30px_60px_rgba(79,70,229,0.05)]">
            <h3 className="text-[10px] font-bold text-slate-300 uppercase tracking-[0.25em] mb-8">Source 02 • XLSX</h3>
            <div className="flex-1 flex flex-col justify-center">
              <label className="cursor-pointer group/label">
                <input type="file" accept=".xlsx,.xls" onChange={handleFileChange('ledgerSheet')} className="hidden" />
                <div className="flex flex-col items-center text-center">
                  <div className={`w-16 h-16 rounded-3xl mb-6 flex items-center justify-center transition-all duration-500 ${files.ledgerSheet ? 'bg-emerald-50 text-emerald-500 scale-110 -rotate-3' : 'bg-slate-50 text-slate-300 group-hover/label:bg-slate-100 group-hover/label:text-slate-400'}`}>
                    <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex justify-center">
        <button
          ...
          className={`
            relative px-14 py-5 rounded-full text-xs font-bold uppercase tracking-[0.3em] transition-all duration-500 overflow-hidden
